...
#define RZ_PROFILE_SCOPE_LINE2(name, line) constexpr auto fixedName##line = ::Razor::InstrumentorUtils::CleanupOutputString(name, "__cdecl ");\
											   ::Razor::InstrumentationTimer timer##line(fixedName##line.Data)
...
#define RZ_PROFILE_FUNCTION() RZ_PROFILE_SCOPE(RZ_FUNC_SIG)
#else
