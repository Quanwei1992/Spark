...
namespace Spark
{
		...
		RenderCommandQueue::Submit([this]()
		{
			...
			if (m_DepthAttachmentSpec.TextureFormat != FramebufferTextureFormat::None)
			{
				...
				case FramebufferTextureFormat::DEPTH24STENCIL8:
					Utils::AttachDepthTexture(m_DeptchAttachment, m_Specification.Samples, GL_DEPTH24_STENCIL8,
	...
	void OpenGLFramebuffer::ClearAttachment(uint32_t attachmentIndex, int value)
	{
		...
		RenderCommandQueue::Submit([this, attachmentIndex, spec,value]()
		{
			glClearTexImage(m_ColorAttachments[attachmentIndex], 0,
			                Utils::FBFormatToGLFormat(spec.TextureFormat),
			                Utils::FBFormatToGLDataType(spec.TextureFormat), &value);
		});
	}
