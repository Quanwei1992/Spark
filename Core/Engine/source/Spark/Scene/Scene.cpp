...
namespace Spark
{
	...
	void Scene::OnUpdateRuntime(Timestep ts)
	{
		...
		// Physics
		{
			...
			const auto view = m_Registry.view<TransformComponent, Rigidbody2DComponent>();
	...
	void Scene::OnPhysics2DStart()
	{
		...
		m_Registry.view<TransformComponent, Rigidbody2DComponent>().each(
			[=](auto e, TransformComponent& transform, Rigidbody2DComponent& rb2d)
			{
				b2BodyDef bodyDef;
